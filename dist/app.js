...
var OpenWeatherMap = /** @class */ (function (_super) {
  ...
  */
   ...
   */
    ...
    OpenWeatherMap.prototype.getAirPollutionByGeoCoordinates = function (latitude, longitude) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var airPollution, error_9;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, this.getByGeoCoordinates({
                                            latitude: latitude,
                                            longitude: longitude,
                                            queryType: helpers_1.AIR_POLLUTION
                                        })];
                                case 1:
                                    airPollution = (_a.sent());
