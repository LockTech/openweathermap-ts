...
class Geocoding extends BaseAPI {
     ...
     */
    getGeoCoordinatesByLocationName(cityName, countryCode, stateCode) {
     ...
     * @returns
     */
    getGeoCoordinatesByZipCode(zipCode, countryCode) {
        return new Promise(async (resolve, reject) => {
            try {
     ...
     * @returns
     */
    getGeoCoordinatesByCityName(cityName) {
        return new Promise(async (resolve, reject) => {
            try {
     ...
     * @returns
     */
    getLocationNameByGeoCoordinates(lat, lon, limit) {
        return new Promise(async (resolve, reject) => {
            try {
